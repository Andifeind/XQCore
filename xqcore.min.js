...
a.dedotify=function(a,b,c){"string"==typeof a&&(c=b,b=a,a={});var d=a;if(b){b=b.split(".");var e=b.length;b.forEach(function(b,d){return d===e-1?/\[\]$/.test(b)?(b=b.substr(0,b.length-2),a[b]||(a[b]=[]),void a[b].push(c)):void(a[b]=c):(a[b]||(a[b]={}),void(a=a[b]))})}return a=c,d},/**
     ...
     */
a.uid=function(a){a=a||7;for(var b="";b.length<a;){var c=Math.random().toString(36).substr(2);b+=c}return b.substr(0,a)},/**
     ...
     */
a.promise=function(a){var b,c,d=new Promise(function(a,d){b=a,c=d});d.resolve=function(c){return b(c),"function"==typeof a&&a(null,c),d},d.reject=function(b){return c(b),"function"==typeof a&&a(b),d};var e=[];return d.push=function(a){if("function"!=typeof a)throw new Error("Could not create a promise chain! First arg is not a function in promise.push().");return e.push(a),this},d.each=function(a){var b=e.shift();return b?(b(a).then(function(a){d.each(a)})["catch"](function(a){d.reject(a)}),d):void d.resolve(a)},d}}(XQCore),/**
...
"function"==typeof this.onSend&&(f=this.onSend.call(this,f)),this.log("Send an ajax call to ",e,"with data: ",f),this.state("syncing");var i=new Promise(function(b,i){c.ajax({url:e,type:d,data:a.isEmpty(f)?null:JSON.stringify(f),dataType:"json",contentType:"application/json",headers:{Accept:"application/json"},success:function(a,c,d){"function"==typeof g&&g.call(h,null,a,c,d),h.state("success"),b(a)},error:function(a,b,c){"function"==typeof g&&g.call(h,{type:b,http:c},null,b,a),h.state("failed"),i({type:b,http:c})}})});return i},/**
     ...
     *
     */
d.prototype.sendPOST=function(a,b,c){return this.send("POST",a,b,c)},/**
     ...
     *
     */
d.prototype.sendGET=function(a,b,c){return this.send("GET",a,b,c)},/**
     ...
     *
     */
d.prototype.sendPUT=function(a,b,c){return this.send("PUT",a,b,c)},/**
     ...
     *
     */
d.prototype.sendDELETE=function(a,b,c){return this.send("DELETE",a,b,c)},/**
     * Fetch data from server
     *
     * @param {Object} query MongoDB query 
     * @param {Function} callback Callback function
     */
d.prototype.fetch=function(a,b){return this.sendGET(a,b)},/**
     * Save a model if it's valid
     */
d.prototype.save=function(a,b){return"function"==typeof a&&(b=a,a=this.schema?this.getByKeys(Object.keys(this.schema)):this.toJSON()),this.isValid()?this.sendPOST(a,b):"function"!=typeof b?Promise.reject({msg:"Model isn't valid. Cancle save"}):void b({msg:"Model isn't valid. Cancle save"})},/**
...
d.prototype.update=function(a,b){"function"==typeof a&&(b=a,a=this.schema?this.getByKeys(Object.keys(this.schema)):this.toJSON()),this.isValid()?this.sendPUT(a,b):"function"==typeof b&&b({msg:"Model isn't valid. Cancel update"})},/**
     ...
     * @param  {Any} data     data
     */
d.prototype.submit=function(a){var c=this,d=new Promise(function(d,e){c.set(a,{extend:!0}).then(function(){c.server&&(c.get("id")===b||null===c.get("id")?c.save(a).then(function(a){d(a),c.emit("data.submit",a)})["catch"](function(a){e(a)}):c.update(a).then(function(a){d(a),c.emit("data.submit",a)})["catch"](function(a){e(a)}))})});return d},a.Sync=d}(XQCore),/**
 * XQCore Presenter
 *
...
d.prototype.initView=function(b,c,d){d=d||{};var e={};d.viewDir&&(e.viewDir=d.viewDir);var f=new a.View(b,function(f){f.template=a.Tmpl.getTemplate(b,e),f.mode=d.mode||"replace",f.container=c||"body",f.hidden=!!d.hidden,f.forms=d.forms,d.inject===!1&&(f.autoInject=!1)});this.__views[b]=f;var g=this;return a.html5Routes&&f.on("xqcore.navigate",function(a){g.router.callRoute(a)}),f},d.prototype.initFormView=function(a,b,c){},/**
     ...
     */
d.prototype.route=function(a,b){var d=this;return"string"==typeof b&&(b=this[b]),"function"==typeof b?"string"==typeof a?this.router.addRoute(a,b):Array.isArray(a)&&a.forEach(function(a){d.router.addRoute(a,b)}):c.warn("Router callback isn't a function",b,"of route",a),this},d.prototype.send=a.Sync.prototype.send,/**
     * Return Presenter
     */
...
e.prototype.validationSucceeded=function(a,b){var c=this;c.$el.find('[name="'+a+'"]').removeClass("xq-invalid")},/**
     ...
     * @override
     */
e.prototype.onStateChange=function(a){if(!this.el)return void(this.__initialState=a);var b=this.el.className.split(" ");b=b.filter(function(a){return!/^xq-state-/.test(a)}),b.push("xq-state-"+a),this.el.className=b.join(" ")},/**
     * Wait till view is ready
     *
     * @method ready
...
e.prototype.ready=function(a){this.isReady?a.call(this):(this.__readyCallbacks||(this.__readyCallbacks=[]),this.__readyCallbacks.push(a))},e.prototype.__setReadyState=function(){var a=this;this.isReady=!0,this.__readyCallbacks&&(this.__readyCallbacks.forEach(function(b){b.call(a)}),this.__readyCallbacks=[])},/**
     ...
     * @method inject
     */
e.prototype.inject=function(){var a=this.isElementInDOM(this.ct);if(this.el.parentNode!==this.ct||!a)if(a||(this.$ct=d(this.container),this.ct=this.$ct.get(0)),c.info("Inject view into container",this.$ct),"replace"===this.mode){var b=this.$ct.contents();b.each(function(){var a=d(this).data("view");a?a.detach():d(this).detach()}),
...
e.prototype.insert=function(a,b,c){var e=this;a in this.scopesMap&&this.scopesMap[a].forEach(function(f){var g=e.renderScope(f,a,[c]);if(-1===b)f.parent.append(g),f.childs.push([g.get()]);else if(0===b)f.parent.prepend(g),f.childs.unshift([g.get()]);else{var h=f.childs[b];d(h[0]).before(g);var i=[b,0].concat([g.get()]);f.childs.splice.apply(f.childs,i)}})},e.prototype.update=function(a,b){c.warn("XQCore doesn`t support update events yet")},e.prototype.append=function(a,b){1===arguments.length&&(b=a,a="data"),this.insert(a,-1,b)},e.prototype.prepend=function(a,b){1===arguments.length&&(b=a,a="data"),this.insert(a,0,b)},/**
     ...
     */
e.prototype.remove=function(a,b){a in this.scopesMap&&this.scopesMap[a].forEach(function(a){var c=a.childs[b];Array.isArray(c)?c.forEach(function(a){d(a).remove()}):d(c).remove(),a.childs.splice(b,1)})},e.prototype.removeLast=function(a){c.warn("XQCore doesn`t support pop events yet")},e.prototype.removeFirst=function(a){c.warn("XQCore doesn`t support shift events yet")},e.prototype.change=function(a,b){var c=this;this.ready(function(){a in this.scopesMap&&this.scopesMap[a].forEach(function(d){"node"===d.type&&c.renderNode(d,a,b)})})},/**
     * Seting up forms
...
e.prototype.onSubmit=function(a,b){return a},/**
     ...
     * @return {[type]} [description]
     */
e.prototype.detach=function(){c.info("Destroy view"),this.emit("view.detach"),this.$el.detach(),this.__coupled&&(
...
//Call current page
b.callRoute(b.getPath(),{initialCall:!0})})};/**
...
h.prototype.removeRoute=function(a){if(!a)throw new Error(" route requires a path");if(!this.routeMap[a])return c.warn("Can not remove route! Route does not exists: "+a),this;for(var b=0;b<this.routes.length;b++){var d=this.routes[b];d.src===a&&this.routes.splice(b,1)}return delete this.routeMap[a],this},h.prototype.match=function(a,b){var c=g(this.routes,a,b);return c&&(c.fn=this.routeMap[c.route],c.next=this.match.bind(this,a,c.next)),c},/**
     ...
     * 
     */
h.prototype.callRoute=function(b,d){if(d=d||{},c.info("Call route",b),void 0===b)throw new Error("XQCore.Router error! Path is undefined in callRoute()!");var e=this.match(b);if(e.path=b,e.initialCall=!!d.initialCall,!e)return void c.warn("Could not call any route! No route were found! Called path: "+b);!a.html5Routes||d.noPush||d.replace?a.html5Routes&&d.replace&&history.replaceState(null,"",b):history.pushState(null,"",b);var f=function(){c.info("... trigger route",this.route,this.fn,this.next),this.fn.call(this,this.params,this.splats,function(){var a=this.next();a&&f.call(a)}.bind(this))};f.call(e)},a.Router=h}(XQCore),/**
 * Socket connection
