...
require.register('./inspect.js', function(module, exports, require) {
/**
...
require.register('./lib/inspectUtils.js', function(module, exports, require) {
'use strict';
...
require.register('./lib/inspectionError.js', function(module, exports, require) {
'use strict';
...
require.register('./lib/errors.js', function(module, exports, require) {
'use strict';

// var jsdiff = rxequire('diff');
// var clc = rxequire('cli-color');
// var utils = rxequire('./inspectUtils');
...
require.register('./lib/sinonInspect.js', function(module, exports, require) {
'use strict';
