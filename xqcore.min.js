 ...
 */
function(a,b){"use strict";var c,d=a.require("jquery"),e=function(b,e){var f=this;"function"==typeof arguments[0]&&(e=b,b=null),/**
         * Set presenter name
         * @public
         * @type {String}
         */
this.name=b||"Nameless",/**
         ...
         * @type {Object}
         */
this.router=a.Router.getInstance(),c=new a.Logger(this.name+"Presenter"),this.__views={},"function"==typeof e&&e.call(this,f,c),d(function(){f.router.callRoute(f.router.getPath())})};a.extend(e.prototype,new a.Event),/**
...
e.prototype.init=function(){},/**
     ...
     */
e.prototype.pushState=function(b,d){
...
var e=a.html5Routes||"/"===b.charAt(0)?"":a.hashBang;b=e+b,history.pushState(d,"",b||null),c.info("Update history with pushState. New URL: "+d,b)},/**
     ...
     * @param {Object} data Data object
     */
e.prototype.replaceState=function(b,d){var e=a.html5Routes||"/"===b.charAt(0)?"":a.hashBang;b=e+b,history.replaceState(d,"",b||null),c.info("Update history with replaceState. New URL: "+d,b)},/**
     ...
     */
e.prototype.navigateTo=function(b,c){c=c||{},a.html5Routes?this.router.callRoute(b,c):(location.hash=a.hashBang+b,this.router.callRoute(b,c))},/**
     * Navigate back
     * 
     * @method navigateBack
     */
e.prototype.navigateBack=function(){history.back()},/**
     ...
     */
e.prototype.getView=function(a){return this.__views[a]||null},/**
     * Returns the current hash
     *
     * @method getHash
     * @returns {String} Returns the current value from location.hash
     */
e.prototype.getHash=function(){return location.hash},/**
     * Returns the current pathname
     *
     * @method getPathname
     * @returns {String} Returns the current value from location.pathname
     */
e.prototype.getPathname=function(){return location.pathname},/**
     ...
     * }
     */
e.prototype.couple=function(b,c,d){d=d||{},c instanceof a.List?this.coupleList(b,c,d):this.coupleModel(b,c,d),this.coupleView(b,c,d)},/**
...
e.prototype.initView=function(b,c,d){d=d||{};var e={};d.viewDir&&(e.viewDir=d.viewDir);var f=new a.View(b,function(f){f.template=a.Tmpl.getTemplate(b,e),f.mode=d.mode||"replace",f.container=c||"body",f.hidden=!!d.hidden,f.forms=d.forms,d.inject===!1&&(f.autoInject=!1)});this.__views[b]=f;var g=this;return a.html5Routes&&f.on("xqcore.navigate",function(a){g.router.callRoute(a)}),f},/**
     ...
     */
e.prototype.route=function(a,b){var d=this;return"string"==typeof b&&(b=this[b]),"function"==typeof b?"string"==typeof a?this.router.addRoute(a,b):Array.isArray(a)&&a.forEach(function(a){d.router.addRoute(a,b)}):c.warn("Router callback isn't a function",b,"of route",a),this},/**
     * Return Presenter
     */
a.Presenter=e}(XQCore),/**
 * XQCore.Sync
 *
 * @module  XQCore.Sync
 */
...
//Handle onSend
"function"==typeof this.onSend&&(e=this.onSend.call(this,e)),this.log("Send an ajax call to ",d,"with data: ",e),this.state("syncing"),c.ajax({url:d,type:a,data:e,dataType:"json",success:function(a,b,c){"function"==typeof f&&f.call(g,null,a,b,c),g.state("success")},error:function(a,b,c){"function"==typeof f&&f.call(g,{type:b,http:c},null,b,a),g.state("failed")}})},/**
...
e.prototype.ready=function(a){this.isReady?a.call(this):(this.__readyCallbacks||(this.__readyCallbacks=[]),this.__readyCallbacks.push(a))},e.prototype.__setReadyState=function(){var a=this;this.isReady=!0,this.__readyCallbacks&&(this.__readyCallbacks.forEach(function(b){b.call(a)}),this.__readyCallbacks=[])},/**
     ...
     * @method inject
     */
e.prototype.inject=function(){if(this.el.parentNode!==this.ct)if(c.info("Inject view into container",this.$ct),"replace"===this.mode){var a=this.$ct.contents();a.each(function(){var a=d(this).data("view");a?a.destroy():d(this).remove()}),
...
a.html5Routes&&b.$el.on("click","a",function(a){/^http(s)?:\/\//.test(a.href)||/^\/?[a-z]/.test(a.href)&&(a.preventDefault(),a.stopPropagation(),b.emit("xqcore.navigate",a.href))}),b.forms&&b.formSetup()})},e.prototype.registerForms=function(){if(this.forms){var a="form";"string"==typeof this.forms&&(a=this.forms),this.ready(function(){this.$forms=this.$el.find(a),this.$forms.addClass("xq-forms"),this.$forms.find(":input").addClass("xq-input")})}},a.View=e}(XQCore),/**
 * XQCore router
 * 
 ...
 * 
 */
function(a){"use strict";var b,c=new a.Logger("Router"),d=function(b){var d,f,g=[];return c.logLevel=a.logLevel,b instanceof RegExp?(f=b,d=b.toString()):(f=e(b,g),d=b),{re:f,src:b.toString(),keys:g}},e=function(a,b){return a=a.concat("/?").replace(/\/\(/g,"(?:/").replace(/(\/)?(\.)?:(\w+)(?:(\(.*?\)))?(\?)?|\*/g,function(a,c,d,e,f,g){return"*"===a?(b.push(void 0),a):(b.push(e),c=c||"",""+(g?"":c)+"(?:"+(g?c:"")+(d||"")+(f||"([^/]+?)")+")"+(g||""))}).replace(/([\/.])/g,"\\$1").replace(/\*/g,"(.*)"),new RegExp("^"+a+"$","i")},f=function(a,b,c){for(var d,e=c||0,f=a.length;f>e;++e){var g=a[e],h=g.re,i=g.keys,j=[],k={};if(d=b.match(h)){for(var l=1,m=d.length;m>l;++l){var n=i[l-1],o="string"==typeof d[l]?unescape(d[l]):d[l];n?k[n]=o:j.push(o)}return{params:k,splats:j,route:g.src,next:e+1}}}},g=function(a){a=a||{},this.routes=[],this.routeMap={},a.noListener||this.registerListener()};/**
     * Returns a singelton instance of XQCore.Router
     * @return {[type]} [description]
     */
g.getInstance=function(){return b||(b=new a.Router),b},g.prototype.registerListener=function(){a.html5Routes?(console.log("DEFINE"),window.addEventListener("popstate",this.onPopStateHandler.bind(this))):window.addEventListener("hashchange",this.onPopStateHandler.bind(this))},g.prototype.onPopStateHandler=function(a){var b=this.getPath();this.callRoute(b,{noPush:!0})},g.prototype.getPath=function(){var b;return a.html5Routes?(b=location.pathname,b.replace(new RegExp("^"+a.basePath),"")):(b=location.hash,b=b.replace(new RegExp("^"+a.hashBang),""),b="/"+b)},/**
     ...
     * @chainable
     */
g.prototype.addRoute=function(a,b){if(c.info("Register new route:",a,b),!a)throw new Error(" route requires a path");if(!b)throw new Error(" route "+a.toString()+" requires a callback");if(this.routeMap[a])throw new Error("path is already defined: "+a);"/"!==a.charAt(0)&&(a="/"+a);var e=new d(a);return e.fn=b,this.routes.push(e),this.routeMap[a]=b,this},/**
     * Removes a route
     *
     * @method removeRoute
...
g.prototype.removeRoute=function(a){if(!a)throw new Error(" route requires a path");if(!this.routeMap[a])return c.warn("Can not remove route! Route does not exists: "+a),this;for(var b=0;b<this.routes.length;b++){var d=this.routes[b];d.src===a&&this.routes.splice(b,1)}return delete this.routeMap[a],this},g.prototype.match=function(a,b){var c=f(this.routes,a,b);return c&&(c.fn=this.routeMap[c.route],c.next=this.match.bind(this,a,c.next)),c},/**
     ...
     * 
     */
g.prototype.callRoute=function(b,d){if(d=d||{},c.info("Call route",b),void 0===b)throw new Error("XQCore.Router error! Path is undefined in callRoute()!");var e=this.match(b);if(!e)return void c.warn("Could not call any route! No route were found! Called path: "+b);!a.html5Routes||d.noPush||d.replace?a.html5Routes&&d.replace&&history.replaceState(null,"",b):history.pushState(null,"",b);var f=function(){c.info("... trigger route",this.route,this.fn,this.next),this.fn.call(this,this.params,this.splats,function(){var a=this.next();a&&f.call(a)}.bind(this))};f.call(e)},a.Router=g}(XQCore),/**
 * Socket connection
