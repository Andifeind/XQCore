...
//--
module.exports=XQCore;var XQCore=require("./xqcore-core");XQCore.undotify=function(a,b){return a&&(a=a.split("."),a.forEach(function(a){b=b?b[a]:void 0})),b},/**
 ...
 */
XQCore.promise=function(a){var b,c,d=new Promise(function(a,d){b=a,c=d});d.resolve=function(c){return b(c),"function"==typeof a&&a(null,c),d},d.reject=function(b){return c(b),"function"==typeof a&&a(b),d};var e=[];return d.push=function(a){if("function"!=typeof a)throw new Error("Could not create a promise chain! First arg is not a function in promise.push().");return e.push(a),this},d.each=function(a){var b=e.shift();return b?(b(a).then(function(a){d.each(a)})["catch"](function(a){d.reject(a)}),d):void d.resolve(a)},d};var XQCore=require("./xqcore-core"),Logger=function(a){this.loggerName=a,this.logLevel=XQCore.logLevel};/**
...
//--
module.exports=Logger;var XQCore=require("./xqcore-core"),log=new XQCore.Logger("EventEmitter"),EventListener=function(a,b,c){this.fn=c,this.calls=0,this.once=!1,/**
     ...
     */
this.remove=function(){a.off(b,c)}},EventEmitter=function(){this.__events={},this.__logger=log,/**
...
return this.properties=e,c.silent!==!0&&(h?c.noSync||"function"!=typeof this.sync?this.emit(c.replace?"data.replace":"data.set",e,f):this.sync(c.replace?"replace":"set",e):g&&(c.noSync||"function"!=typeof this.sync||this.sync("value",a,b),this.emit("value.set",a,b)),this.emit("data.change",e,f)),Promise.resolve(e)},/**
 ...
 */
Model.prototype.validate=function(a,b){var c,d=this,e=[];return b=b||this.schema,b&&Object.keys(b).forEach(function(f){if("object"==typeof a[f]&&"undefined"==typeof b[f].type)return void(b[f].ref&&b[f].schema?(console.log("Has a subref to %s",b[f].ref),c=d.validate(a,b[f].schema),c&&(e=e.concat(c))):(c=d.validate(XQCore.extend({},a[f]),XQCore.extend({},b[f])),Array.isArray(c)&&c.length>0&&(e=e.concat(c))));var g=d.validateOne(b[f],a[f]);g.isValid===!0?a[f]=g.value:(g.error.property=f,e.push(g.error))}),0===e.length?(this.__isValid=!0,this.lastValidationErr=null,this.state("valid"),null):(this.__isValid=!1,this.lastValidationErr=e,this.state("invalid"),e)},/**
 ...
 */
Model.prototype.validateOne=function(a,b,c){var d,e="function"==typeof a.type?typeof a.type():a.type.toLowerCase();if(""===b&&a.noEmpty===!0&&(b=void 0),void 0!==b&&null!==b&&""!==b||!a["default"]||(b=a["default"]),void 0===b||null===b||""===b)a.required===!0&&(d={msg:"Property is undefined or null, but it's required",errCode:10});else{if(!this.__registeredValidations[e])throw new Error("Undefined schema type",a);d=this.__registeredValidations[e].call(this,b,a)}return d=void 0===d?{isValid:!0,value:b,error:null}:{isValid:!1,value:b,error:d}},/**
...
XQCore.Event.call(this),"object"==typeof arguments[0]&&(b=a,a=b.name),/**
     ...
     * @type {Boolean}
     */
this.logLevel=XQCore.logLevel,void 0===b&&(b={}),"function"==typeof b?b.call(this,this):XQCore.extend(this,b),this.conf=b,this.name=(a?a.replace(/Model$/,""):"Nameless")+"Model",this.__state="ready"};
//Extend with ready state
// XQCore.extend(Service.prototype, XQCore.ReadyState.prototype);
// XQCore.extend(Service.prototype, XQCore.Event.prototype);
XQCore.extend(Service.prototype,XQCore.Event.prototype),XQCore.extend(Service.prototype,new XQCore.Logger),XQCore.extend(Service.prototype,XQCore.Sync.prototype),/**
 * Inherits a model prototype
 * @method inherit
 * @param  {String} name    model name
