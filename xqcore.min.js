...
a.uid=function(a){a=a||7;for(var b="";b.length<a;){var c=Math.random().toString(36).substr(2);b+=c}return b.substr(0,a)},/**
     ...
     */
a.promise=function(a){var b,c,d=new Promise(function(a,d){b=a,c=d});return d.resolve=function(c){return b(c),"function"==typeof a&&a(null,c),d},d.reject=function(b){return c(b),"function"==typeof a&&a(b),d},d}}(XQCore),/**
...
d.prototype.onSend=function(a){return a},/**
     ...
     */
d.prototype.send=function(d,e,f,g){var h=this;"object"==typeof e?(g=f,f=e,e=this.server,d=d):"function"==typeof f?(g=f,f=this.toJSON()):f===b&&(f=this.toJSON()),d===b&&(d="POST"),e||(e=this.server),"GET"===d&&Array.isArray(f)&&(e=e.replace(/\/$/,"")+"/"+f.join("/"),f=null),
//Handle onSend
...
d.prototype.update=function(a,b){"function"==typeof a&&(b=a,a=this.schema?this.getByKeys(Object.keys(this.schema)):this.toJSON()),this.isValid()?this.sendPUT(a,b):"function"==typeof b&&b({msg:"Model isn't valid. Cancel update"})},/**
     ...
     * @param  {Any} data     data
     */
d.prototype.submit=function(a){var c=this,d=new Promise(function(d,e){c.set(a,{extend:!0}).then(function(){c.server&&(a.id===b||null===a.id?c.save(a).then(function(a){d(a),c.emit("data.submit",a)})["catch"](function(a){e(a)}):c.update(a).then(function(a){d(a),c.emit("data.submit",a)})["catch"](function(a){e(a)}))})});return d},a.Sync=d}(XQCore),/**
 * XQCore Model
 *
